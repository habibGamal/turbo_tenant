...
export default function Navigation({
    ...
    const formatNotificationTime = (dateString: string) => {
        ...
        if (diffMins < 60) return i18n.language === 'ar' ? `منذ ${diffMins} دقيقة` : `${diffMins}m ago`;
        if (diffHours < 24) return i18n.language === 'ar' ? `منذ ${diffHours} ساعة` : `${diffHours}h ago`;
        if (diffDays < 7) return i18n.language === 'ar' ? `منذ ${diffDays} يوم` : `${diffDays}d ago`;
